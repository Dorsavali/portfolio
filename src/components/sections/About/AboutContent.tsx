...
export default function AboutContent() {
  ...
  return (
    <div className="flex flex-col items-center text-center lg:items-start lg:text-left ">
      ...
      <h2 className="max-w-xl text-xl font-bold leading-[1.7] tracking-tight text-text-primary sm:text-2xl lg:text-4xl font-[geo]">
        I’m a web developer who loves building
        <span className="text-primary"> beautiful things.</span>
      </h2>

      <p className="mt-6 max-w-xl text-base leading-8 text-text-secondary text-[12px] font-[geo]">
